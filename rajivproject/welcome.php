...
echo "<option value ='" . $rowc['country_id']."' ".$strc.">".$rowc['country_name']."</option>";
}
echo "</select>";
 ?>
<br></br> 
...
state_id:
<?php
 $query = "SELECT * FROM state where country_id =country_id ORDER BY state_name "; 
...
echo "<option value ='" . $rows['state_id']."' ".$strs.">".$rows['state_name']."</option>";
}
echo "</select>";
?>
<br></br>
city_id:
<?php
$query = "SELECT * FROM city where state_id =state_id ORDER BY city_name ";
$result =$mysqli->query($query);
